...
#define LIBNG_ENUM_BITWISE_OPERATOR(T)                                                                       \
  LIBNG_INLINE constexpr T    operator~ (T x)        { return static_cast<T>(~enumToInt(x));               } \
  LIBNG_INLINE constexpr T    operator| (T  a, T b)  { return static_cast<T>(enumToInt(a) | enumToInt(b)); } \
  LIBNG_INLINE constexpr T    operator& (T  a, T b)  { return static_cast<T>(enumToInt(a) & enumToInt(b)); } \
  LIBNG_INLINE constexpr T    operator^ (T  a, T b)  { return static_cast<T>(enumToInt(a) ^ enumToInt(b)); } \
  LIBNG_INLINE constexpr void operator|=(T& a, T b)  {    a = static_cast<T>(enumToInt(a) | enumToInt(b)); } \
  LIBNG_INLINE constexpr void operator&=(T& a, T b)  {    a = static_cast<T>(enumToInt(a) & enumToInt(b)); } \
  LIBNG_INLINE constexpr void operator^=(T& a, T b)  {    a = static_cast<T>(enumToInt(a) ^ enumToInt(b)); } \
  // ----
...
#define LIBNG_ENUM_ARITHMETIC_OPERATOR_INT(T)                                                      \
  LIBNG_INLINE constexpr T    operator+ (T  a, int b) { return static_cast<T>(enumToInt(a) + b); } \
  LIBNG_INLINE constexpr T    operator- (T  a, int b) { return static_cast<T>(enumToInt(a) - b); } \
  LIBNG_INLINE constexpr T    operator* (T  a, int b) { return static_cast<T>(enumToInt(a) * b); } \
  LIBNG_INLINE constexpr T    operator/ (T  a, int b) { return static_cast<T>(enumToInt(a) / b); } \
  LIBNG_INLINE constexpr void operator+=(T& a, int b) {    a = static_cast<T>(enumToInt(a) + b); } \
  LIBNG_INLINE constexpr void operator-=(T& a, int b) {    a = static_cast<T>(enumToInt(a) - b); } \
  LIBNG_INLINE constexpr void operator*=(T& a, int b) {    a = static_cast<T>(enumToInt(a) * b); } \
  LIBNG_INLINE constexpr void operator/=(T& a, int b) {    a = static_cast<T>(enumToInt(a) / b); } \
  // ----
